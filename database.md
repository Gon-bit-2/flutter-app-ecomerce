...
savedDiscounts UserSavedDiscount[]
...
createdAt DateTime @default(now())
updatedAt DateTime @updatedAt
discountsOnCategories DiscountsOnCategories[]
...
value Float
type DiscountType
scope DiscountScope @default(SHOP)
code String @unique @db.VarChar(255)
description String @db.Text
maxTotalUses Int @default(0)
...
products DiscountsOnProducts[]
categories DiscountsOnCategories[]
savedByUsers UserSavedDiscount[]
