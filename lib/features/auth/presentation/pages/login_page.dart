      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              // Handle back if needed, or remove if root
            },
          ),
          title: Text(
            "Log In",
              ...
              if (state is AuthGoogleUrlSuccess) {
                ...
                try {
                  if (await canLaunchUrl(uri)) {
                    ...
                    // Fallback try launch without check or specific mode if check fails (sometimes on some emulators)
                    await launchUrl(uri);
                  }
                } catch (e) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text("Could not launch Google Login: $e"),
                    ),
                  );
                }
              }
